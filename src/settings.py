...
##################################
PROJECT_NAME: str = "FIRE"
PROJECT_NAME_FULL: str = "FIRE: Fundus Image Registration Dataset"
...
HOMEPAGE_URL: str = "https://projects.ics.forth.gr/cvrl/fire/"
# e.g. "https://some.com/dataset/homepage"

PREVIEW_IMAGE_ID: int = 16575939
# This should be filled AFTER uploading images to instance, just ID of any image.

GITHUB_URL: str = "https://github.com/dataset-ninja/fire-fundus"
...
SLYTAGSPLIT: Optional[Dict[str, Union[List[str], str]]] = {
    "categories": "category",
    "__POSTTEXT__": "Additionally, every image grouped with its ***im_id*** tag",
}
TAGS: Optional[
    List[
        Literal[
